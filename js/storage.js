define([
  ...
  const storage = {
    ...
    storeManifest: () => {
      ...
      const manifestFullFilePath = 'jupytergraffiti/' + manifestInfo.path + manifestInfo.file;
      console.log('Graffiti: Saving manifest to:', manifestFullFilePath, manifest);
      storage.writeTextToFile({path:'jupytergraffti/', contents:'test', stripCRs: false });
