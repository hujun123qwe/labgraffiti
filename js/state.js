define([
  ...
  const state = {
    ...
    createDrawingRecord: (opts) => {
      console.log("HJ:createDrawingRecord");
    ...
    createSelectionsRecord: () => {
      console.log("HJ:createSelectionsRecord");
    ...
    extractDataFromContentRecord: (record, cellId) => {
      console.log("HJ:extractDataFromContentRecord");
    ...
    createContentsRecord: (doBackRefStore) => {
      console.log("HJ:createContentsRecord");
